...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println("Listing book with id 1001");
		System.out.println("Book with ID 106:" + service.getBookById(1001));
		...
		System.out.println("Listing book written by Dhruv Majethia");
		for (Book book : service.getAuthorBooks("Dhruv Majethia")) {
			System.out.println(book);
		}
